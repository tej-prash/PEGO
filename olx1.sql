...
INSERT into product(`product_id`,`name`,`category_id`,`picture_url`,`description`,`cost`,`discount`,`features`,`ownerid`,`available_flag`) values('po001', 'car', 'c001', './data/Pictures/po001', 'Maruti Suzuki Swift Dzire. About 5 years old', '500000','0','Automatic;Insurance cover of 3 years;Blue in color;Bluetooth;Power steering','uaa001',1);
INSERT into product(`product_id`,`name`,`category_id`,`picture_url`,`description`,`cost`,`discount`,`features`,`ownerid`,`available_flag`) values('po002', 'car', 'c001', './data/Pictures/po002', 'New Audi A10', '2000000','0','Manual;Insurance cover of 3 years;Red in color;Bluetooth;','uaa002',1);
INSERT into product(`product_id`,`name`,`category_id`,`picture_url`,`description`,`cost`,`discount`,`features`,`ownerid`,`available_flag`) values('po003', 'phone', 'c004', './data/Pictures/po003', 'Brand new iPhone10', '70000','0','Grey in color; 64GB storage;1GB RAM','uaa001',1);
INSERT into product(`product_id`,`name`,`category_id`,`picture_url`,`description`,`cost`,`discount`,`features`,`ownerid`,`available_flag`) values('po004', 'bike', 'c001', './data/Pictures/po004', '4 year old Royal Enfield Bullet', '1500000','0','Black color;350CC engine capacity','uaa006',1);
INSERT into product(`product_id`,`name`,`category_id`,`picture_url`,`description`,`cost`,`discount`,`features`,`ownerid`,`available_flag`) values('po005', 'sofa', 'c002', './data/Pictures/po005', 'A new 2 seater-sofa set','75000','0','Black color; Soft cushions; Hard exterior;','uaa007',1);
INSERT into product(`product_id`,`name`,`category_id`,`picture_url`,`description`,`cost`,`discount`,`features`,`ownerid`,`available_flag`) values('po006', 'shirts', 'c005', './data/Pictures/po006', 'Shirts from Levi', '100', '0','Size:M','uaa001',1);
INSERT into product(`product_id`,`name`,`category_id`,`picture_url`,`description`,`cost`,`discount`,`features`,`ownerid`,`available_flag`) values('po007', 'HP laptop', 'c003', './data/Pictures/po007', 'HP x360 pavilion', '55000', '0','1TB HDD + 128GB SSD,8GB RAM,Warranty available;Battery in good condition','uaa014',1);
INSERT into product(`product_id`,`name`,`category_id`,`picture_url`,`description`,`cost`,`discount`,`features`,`ownerid`,`available_flag`) values('po008', 'Asus Zenfone', 'c004', './data/Pictures/po008', 'Asus Zenfone 3', '20000', '0','6GB RAM; 64GB storage; 10MP rear camera','uaa010',1);
